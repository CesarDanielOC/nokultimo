...
def registrarPedido(request):
    ...
    guardarpedido = Receta.objects.create(id_pedido=id_pedido, id_cliente=id_cliente, fecha_receta=fecha_receta,
                                          total_pedido=total_pedido, estado_pedido=estado_pedido,
                                          metodo_pago=metodo_pago, direccion_envio=direccion_envio)
